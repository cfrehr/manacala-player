...
//
// Description: 	Mancala game playing program w/ student AI implemented using:
//						- minimax search
//						- alpha-beta pruning
...
// 
// Instructions:	You are "humanPlayer" aka "Player1"
//					I am "frehrPlayer" aka "Player2"
//					Click board to move beans
//					10 second time limit on moves, which can be adjusted below 
//						if you think I'm too slow... (:<
//
// Files (author):  frehrPlayer.java 	(Cody Frehr)      
